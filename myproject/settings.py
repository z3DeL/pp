...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            ...
            'debug': False,  # Отключаем режим отладки шаблонов
        },
    },
]
...
DISABLE_YC_STORAGE = os.environ.get('DISABLE_YC_STORAGE', '').lower() == 'true'

if not DISABLE_YC_STORAGE:
    ...
    # Локальное хранение статических файлов с использованием WhiteNoise
